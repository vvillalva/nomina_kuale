...
# See LICENSE file for full copyright and licensing details
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            # custom_widgets for selection and text fields
            '/spiffy_theme_backend/static/src/widgets/toolbar/toolbar.js',
            '/spiffy_theme_backend/static/src/widgets/toolbar/toolbar.xml',

            '/spiffy_theme_backend/static/src/widgets/notebook/notebook.scss',
            '/spiffy_theme_backend/static/src/widgets/container/group/containers.scss',

            '/spiffy_theme_backend/static/src/widgets/container/select/customSelect.js',
            '/spiffy_theme_backend/static/src/widgets/container/select/customSelect.scss',
            '/spiffy_theme_backend/static/src/widgets/container/select/customSelect.xml',

            '/spiffy_theme_backend/static/src/widgets/container/char/formWidget.js',
            '/spiffy_theme_backend/static/src/widgets/container/char/formWidget.scss',
            '/spiffy_theme_backend/static/src/widgets/container/char/formWidget.xml',

            # custom_view for dynamic filters
            'spiffy_theme_backend/static/src/adaptative_filter/adaptative_filter.js',
            'spiffy_theme_backend/static/src/adaptative_filter/adaptative_filter.xml',
            'spiffy_theme_backend/static/src/adaptative_filter/adaptative_filter.scss',
        ],
        'web.assets_frontend': [
